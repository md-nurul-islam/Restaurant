...
//
    public SearchAdapter(Context context, PaginationAdapterCallback mCallback, SearchResultFragment homeFragment) {
    ...
    public SearchAdapter(Context context, HomeFragment homeFragment, ArrayList<String> strList) {
        this.context = context;
        this.mCallback = mCallback;
