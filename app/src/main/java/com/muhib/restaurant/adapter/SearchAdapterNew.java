...
public class SearchAdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OrderActionListener {
...
//    private int[] linkArray = {AppConstant.NEWS, AppConstant.SCITECH, AppConstant.APPS_GAMES, AppConstant.CHAMPION, AppConstant.LIFE_STYLE, AppConstant.RESOURCE_CENTER, AppConstant.SPORTS, AppConstant.ENTERTAINMENT, AppConstant.VIDEO};
    ...
    LinearLayout layout;
    SearchResultFragment homeFragment;
//
    private String errorMsg;
    //HomeFragment homeFragment;
//
    public SearchAdapterNew(Context context, PaginationAdapterCallback mCallback, SearchResultFragment homeFragment) {
    ...
    public SearchAdapterNew(Context context) {
        this.context = context;
        orderList = new ArrayList<>();
    }

    public SearchAdapterNew(Context context, HomeFragment homeFragment, ArrayList<String> strList) {
        this.context = context;
        this.mCallback = mCallback;
